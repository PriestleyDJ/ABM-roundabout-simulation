...
namespace ABMTrafficSimulation {
    public static class TrafficEditorInspector {
        ...
        public static void DrawInspector(TrafficNetwork trafficSystem, SerializedObject serializedObject, out bool restructureSystem) {
            //-- Gizmo settings
            Header("Gizmo Config");
            Toggle("Show Gizmos", ref trafficSystem.showGizmos);
            ...
            FloatField("Segment Detection Threshold", ref trafficSystem.laneDetection);
        ...
        private static void DrawArrowTypeSelection(TrafficNetwork trafficSystem) {
